...
/**
 * Publicado por {@code TagUseCase.deleteTag} (f004) após reatribuir (MOVE) ou apagar as
 * transações vinculadas (DELETE). Reagido por {@code TagDeletedListener} (f004), que purga
