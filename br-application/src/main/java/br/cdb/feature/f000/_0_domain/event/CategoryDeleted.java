...
/**
 * Publicado por {@code CategoryUseCase.deleteCategory} (f004) após validar a subárvore a apagar.
 * Reagido por {@code CategoryDeletedListener} (f004), que apaga as linhas {@code PERSON_CATEGORY}
