...
/**
 * Porta só de {@code F006_TRANSACTION} (CRUD + re-keys em massa). Os vínculos transação↔categoria e
 * transação↔tag, tabelas à parte, têm portas próprias: {@link TransactionCategoryRepository} e
 * {@link TransactionTagRepository}.
 */
@NullMarked
