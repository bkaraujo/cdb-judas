 ...
 * <ul>
 *   <li>{@link br.cdb.feature.user.accounts.balance}      — saldo mensal/anual por conta</li>
 *   <li>{@link br.cdb.feature.user.accounts.cards}        — CRUD de cartões (entidade do contexto monetário, identificada só pelo last4)</li>
 *   <li>{@link br.cdb.feature.user.accounts.closing}      — período de fechamento de fatura</li>
 *   <li>{@link br.cdb.feature.user.accounts.statement}    — parsing de extratos/faturas PDF (suporte à importação, sem rota própria)</li>
 ...
 */
@NullMarked
package br.cdb.feature.user.accounts;
