 ...
 *
 * <p>{@code purchasedAt}: data real da compra (fixa no grupo de parcelamento; igual a {@code date}
 * para lançamentos avulsos e extrato bancário). {@code date}: data desta parcela (bucketing).
 */
@NullMarked
