/* kernel/_0_domain/account.js — Account entity + rules. Pure.
 *
 * Movido de feature/accounts.js pro kernel: transactions/credit-cards/statement/dashboard
 * (fatias irmãs de accounts) precisam da forma pura (currentBalance/hasCards) pra montar linhas
 * de extrato/fatura e o índice de cartões — mesmo critério já usado para Domain.Category/Tag.
 * O serviço/CRUD de contas continua em feature/accounts.js. */
(function () {
  const TYPES = {
    CHECKING:    'CHECKING',
