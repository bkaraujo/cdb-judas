 ...
 * fatia fina do backend f002). Um arquivo por fatia: domain → application → infrastructure/
 * secondary → infrastructure/primary, cada bloco abaixo é um IIFE independente (comentário
 * original de cada arquivo preservado como separador de seção). */

/* domain — Account entity + rules. Pure. */
(function () {
  const TYPES = {
    CHECKING:    'CHECKING',
