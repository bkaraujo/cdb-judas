 ...
 * por fatia: domain → application → infrastructure/secondary → infrastructure/primary
 * (create-edit modal → actions de linha → página), cada bloco abaixo é um IIFE independente
 * (comentário original de cada arquivo preservado como separador de seção).
 *
...
/* domain — Transaction entity + rules. Pure. */
(function () {
