...
public abstract class AbstractUseCaseTest {
    ...
    protected CardRepository cardRepository() { return Registry.get(CardRepository.class); }
    ...
    public void beforeEach() {
        ...
        Registry.tryGet(CardRepository.class, InMemoryRepositories.Cards::new).clearCache();
