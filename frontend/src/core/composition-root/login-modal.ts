...
import { modal } from '../kernel/_2_infrastructure/primary/ui/modal.ts';
import type { Modal } from '../kernel/_2_infrastructure/primary/ui/modal.ts';
...
import type { SessionService } from '../kernel/_1_application/session-service.ts';
