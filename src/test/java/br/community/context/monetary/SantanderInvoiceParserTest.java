...
import br.community.feature.user.accounts.statement.importer.provider.SantanderInvoiceParser;
...
class SantanderInvoiceParserTest {
    ...
    private final SantanderInvoiceParser parser = new SantanderInvoiceParser();
    ...
    void parsesParcelamentoLineWithInstallmentDateAndAmount() throws IOException {
        ...
        assertTrue(st.stream().anyMatch(l ->
                l.description().equals("DECATHLON")
                        ...
                        && MonthDay.from(l.date()).equals(MonthDay.of(8, 3))
    ...
    void keepsAnnuityAsFeeAndForeignIofAnchoredToItsPurchaseDate() throws IOException {
        ...
        assertTrue(st.stream().anyMatch(l ->
                l.kind() == ChargeKind.IOF
                        ...
                        && MonthDay.from(l.date()).equals(MonthDay.of(3, 20))));
    }
    ...
    private static String fixture(String name) throws IOException {
        try (InputStream in = SantanderInvoiceParserTest.class.getResourceAsStream("/faturas/" + name)) {
