...
public class CategoryResource {
    ...
    public CategoryDTO create(@RequestBody @Valid CreateRequest req) {
    ...
    @PatchMapping("/{id}")
    public CategoryDTO update(@PathVariable UUID id, @RequestBody @Valid UpdateRequest req) {
    ...
    private CategoryDTO toDto(MonetaryCategory entity) {
