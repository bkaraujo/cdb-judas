 ...
 * parsing. The bank statement (extrato de conta corrente) is recognized by its header marker
 * {@code "Extrato de conta corrente"} and its column header {@code "Data e hora ... Saldo Diário"};
 * BTG also stamps the checking-account CNPJ {@code 30.306.294/0002-26} (digits {@code ...000226}),
 * which differs from the credit-card CNPJ {@code ...000145}. Anything not recognized as a statement
 * is treated as a credit-card invoice so the existing flow is unchanged.
 */
@NullMarked
