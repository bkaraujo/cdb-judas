...
public final class ConnectionWrapper implements Connection {
    ...
    /**
     * Guarda de uso-após-close. Depois do {@link #close()} a conexão física já foi devolvida ao pool e
     * pode estar a servir outra thread — delegar às cegas commitaria/leria trabalho alheio. A manutenção
     * do pool não passa por aqui: {@link ConnectionPool#release(java.sql.Connection)} opera sobre a
     * conexão crua, não sobre este wrapper.
     */
